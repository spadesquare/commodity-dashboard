...
export function WorldMap({
  ...
  const svgMap = useMemo(
    () => map.getSVG({
      radius: 0.22,
      color: dark ? "rgba(120,130,180,0.25)" : "#00000030",
      shape: "circle",
      backgroundColor: dark ? "#05080f" : "white",
    }),
    [map, dark]
  );
  ...
  return (
    <div className={`w-full rounded-lg relative font-sans overflow-hidden${fillHeight ? ' h-full' : ' aspect-[2/1] md:aspect-[2.5/1] lg:aspect-[2/1]'}`} style={{ background: dark ? '#05080f' : 'white' }}>
      <Image
